...
class Window(QtWidgets.QMainWindow):
    ...
    def load_location0(self):
        ...
        lineEdit0.clear() # You must first clear the lineEdit, otherwise, new address will be added to the previous one!
    ...
    def load_location1(self):
        ...
        lineEdit1.clear() # You must first clear the lineEdit, otherwise, new address will be added to the previous one!
    ...
    def load_location2(self):
        ...
        lineEdit2.clear() # You must first clear the lineEdit, otherwise, new address will be added to the previous one!
    ...
    def Autism_Screening(self):
        ...
        if self.saveVideo == 1:
            ...
            fps = inVid.get(cv.CAP_PROP_FPS)
            outVid = cv.VideoWriter(loc1Name, fourcc, fps, (1280, 720))
        ...
        # System initialization (Initial value of variables)
        ori_res, prv_ori, counter, direction = 10, 0, 0, "right"
